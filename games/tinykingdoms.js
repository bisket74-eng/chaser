...
'.tk-action.help:disabled{background:#0d47a1!important;color:#ffffff!important;opacity:1!important;}',
        ...
        '.tk-help-overlay{position:fixed;inset:0;background:#e2f0d9;z-index:999999;overflow-y:auto;-webkit-overflow-scrolling:touch;}',
'.tk-help-close-x{position:fixed;top:12px;right:16px;border:none;background:#b00020;color:#ffffff;font-size:22px;font-weight:900;width:38px;height:38px;border-radius:50%;display:flex;align-items:center;justify-content:center;box-shadow:0 3px 8px rgba(0,0,0,.3);z-index:1000000;}',
