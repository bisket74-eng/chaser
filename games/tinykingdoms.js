...
function setupKingdomZoom() {
    ...
    // Attach listeners to the permanent root container, not the viewport that gets overwritten
    if (root.__tinyKingdomsZoomWired) return;
    root.__tinyKingdomsZoomWired = true;
    ...
    root.addEventListener("touchstart", function (e) {
        if (!e.target.closest(".tk-board-viewport")) return;
        moved = false;
