...
window.initSolitaireGame = function () {
  ...
  /* ============================================================
    ...
    const WORDS = [
       ...
       "ABANDON", "ABILITY", "ABSOLUTE", "ABSORB", "ABSTRACT", "ACADEMIC", "ACCENT", "ACCEPT", "ACCESS", "ACCIDENT",
"ACCOUNT", "ACCURATE", "ACCUSE", "ACHIEVE", "ACIDIC", "ACOUSTIC", "ACQUIRE", "ACROSS", "ACTION", "ACTIVE",
"ACTOR", "ACTUAL", "ADAPT", "ADDICT", "ADDRESS", "ADJUST", "ADMIRE", "ADMIT", "ADOPT", "ADULT",
"ADVANCE", "ADVICE", "ADVISE", "AEROBIC", "AFFAIR", "AFFECT", "AFFORD", "AFRAID", "AGAINST", "AGENCY",
"AGENDA", "AGENT", "AGREE", "AHEAD", "AIRPORT", "ALARM", "ALBUM", "ALCOHOL", "ALERT", "ALIEN",
"ALIVE", "ALLEY", "ALLOW", "ALMOST", "ALONG", "ALPHA", "ALREADY", "ALTER", "ALWAYS", "AMATEUR",
"AMAZE", "AMBER", "AMBITIOUS", "AMOUNT", "AMUSE", "ANALOG", "ANALYZE", "ANCHOR", "ANCIENT", "ANGEL",
"ANGER", "ANGLE", "ANGRY", "ANKLE", "ANNOUNCE", "ANNUAL", "ANOTHER", "ANSWER", "ANXIETY", "ANYBODY",
"ANYMORE", "ANYONE", "ANYTHING", "ANYWAY", "ANYWHERE", "APART", "APOLOGY", "APPAREL", "APPEAL", "APPEAR",
"APPLE", "APPLY", "APPOINT", "APPROACH", "APPROVE", "APRIL", "APRON", "ARCADE", "ARCHITECT", "ARCTIC",
"ARGUE", "ARISE", "ARMOR", "AROUND", "AROUSE", "ARRANGE", "REST", "ARRIVE", "ARROW", "ARTIST",
"ARTISTIC", "ASBESTOS", "ASCEND", "ASPHALT", "ASPIRIN", "ASSAULT", "ASSEMBLE", "ASSERT", "ASSESS", "ASSET",
"ASSIGN", "ASSIST", "ASSOCIATE", "ASSUME", "ASSURE", "ASTONISH", "ASYLUM", "ATHLETE", "ATHLETIC", "ATMOSPHERE",
"ATOMI", "ATTACH", "ATTACK", "ATTAIN", "ATTEMPT", "ATTEND", "ATTITUDE", "ATTRACT", "AUCTION", "AUDIENCE",
"AUDIO", "AUDIT", "AUGUST", "AUNTIE", "AUTHOR", "AUTUMN", "AVAIL", "AVENUE", "AVERAGE", "AVOCADO",
"AVOID", "AWAKE", "AWARD", "AWARE", "AWAY", "AWFUL", "AWKWARD", "AXIOM", "BABY", "BACKPACK",
"BACKWARD", "BACON", "BAGGAGE", "BAKER", "BALANCE", "BALCONY", "BALLOON", "BAMBOO", "BANANA", "BANDAGE",
"BANGKOK", "BARGAIN", "BARREL", "BARRIER", "BASEBALL", "BASIC", "BASIS", "BASKET", "BATTERY", "BATTLE",
"BEACH", "BEACON", "BEARD", "BEAUTY", "BECAUSE", "BECOME", "BEDROOM", "BEFORE", "BEGIN", "BEHAVE",
"BEHIND", "BELIEF", "BELIEVE", "BELLOW", "BELONG", "BELOW", "BENCH", "BENEATH", "BENEFIT", "BERRY",
"BESIDE", "BESIDES", "BETRAY", "BETWEEN", "BEYOND", "BICYCLE", "BINDER", "BIOLOGY", "BIOGRAPHY", "BISCUIT",
"BITTER", "BIZARRE", "BLACK", "BLAME", "BLANKET", "BLAST", "BLEAK", "BLEED", "BLEND", "BLESS",
"BLIND", "BLINK", "BLOCK", "BLONDE", "BLOOD", "BLOOM", "BLOUSE", "BLUEBERRY", "BLUNT", "BLUSH",
"BOARD", "BOAST", "BOILER", "BOLDNESS", "BOLT", "BOMBER", "BONUS", "BOOKCASE", "BOOMERANG", "BORDER",
"BORING", "BORROW", "BOSNIA", "BOSS", "BOTTLE", "BOTTOM", "BOUNCE", "BOUNTY", "BOURBON", "BOWLING",
"BOXER", "BRACELET", "BRAID", "BRAIN", "BRAKE", "BRANCH", "BRAND", "BRAVE", "BRAVERY", "BREAD",
"BREAK", "BREAKFAST", "BREAST", "BREATH", "BREATHE", "BREEZE", "BRICK", "BRIDE", "BRIDGE", "BRIEF",
"BRIGHT", "BRILLIANT", "BRING", "BRISK", "BROAD", "BROADCAST", "BROCCOLI", "BROKEN", "BRONZE", "BROOK",
"BROOM", "BROTHER", "BROWN", "BRUISE", "BRUSH", "BRUTAL", "BUBBLE", "BUCKET", "BUCKLE", "BUDGET",
"BUFFALO", "BUFFER", "BUGGY", "BUILD", "BUILDING", "BULLET", "BUNDLE", "BUNKER", "BURDEN", "BUREAU",
"BURGER", "BURIAL", "BURN", "BURST", "BUSIEST", "BUSINESS", "BUSTLE", "BUTCHER", "BUTTER", "BUTTON",
"BYPASS", "CABIN", "CABINET", "CABLE", "CACTUS", "CAFE", "CAGE", "CAKE", "CALCIUM", "CALENDAR",
"CALF", "CALL", "CALM", "CAMERA", "CAMP", "CAMPAIGN", "CAMPUS", "CANAL", "CANCEL", "CANCER",
"CANDIDATE", "CANDLE", "CANDY", "CANOE", "CANOPY", "CANVAS", "CANYON", "CAPABLE", "CAPACITY", "CAPE",
"CAPITAL", "CAPSULE", "CAPTAIN", "CAPTION", "CARAMEL", "CARBON", "CARD", "CARDBOARD", "CARDIAC", "CARE",
"CAREER", "CAREFUL", "CARELESS", "CARGO", "CARNIVAL", "CARPET", "CARRIAGE", "CARROT", "CARRY", "CART",
"CARTEL", "CARTON", "CARTOON", "CARVE", "CASCADE", "CASE", "CASH", "CASHEW", "CASHIER", "CASINO",
"CASKET", "CASSETTE", "CASTLE", "CASUAL", "CATALOG", "CATCH", "CATEGORY", "CATER", "CATHEDRAL", "CATTLE",
"CAUGHT", "CAUSE", "CAUTION", "CAUTIOUS", "CAVALRY", "CAVE", "CAVERN", "CAVIAR", "CEASE", "CEILING",
"CELEBRATE", "CELEBRITY", "CELLAR", "CELLO", "CEMENT", "CEMETERY", "CENSOR", "CENSUS", "CENTER", "CENTURY",
"CERAMIC", "CEREAL", "CERTAIN", "CERTIFY", "CHAIN", "CHAIR", "CHAIRMAN", "CHALICE", "CHALK", "CHALLENGE",
"CHAMBER", "CHAMPION", "CHANCE", "CHANCELLOR", "CHANGE", "CHANNEL", "CHAOS", "CHAPEL", "CHAPTER", "CHARACTER",
"CHARCOAL", "CHARGE", "CHARIOT", "CHARITY", "CHARM", "CHARTER", "CHASE", "CHASM", "CHASSIS", "CHAT",
"CHEAP", "CHEAT", "CHECK", "CHEEK", "CHEER", "CHEESE", "CHEF", "CHEMICAL", "CHEMIST", "CHEMISTRY",
"CHEQUE", "CHERRY", "CHESS", "CHEST", "CHEW", "CHICKEN", "CHIEF", "CHILD", "CHILDHOOD", "CHILL",
"CHIMNEY", "CHIMP", "CHIN", "CHINA", "CHIP", "CHIRP", "CHISEL", "CHOCOLATE", "CHOICE", "CHOIR",
"CHOOSE", "CHOP", "CHORD", "CHORUS", "CHOSEN", "CHROME", "CHRONIC", "CHUCKLE", "CHURCH", "CIDER",
"CIGAR", "CIGARETTE", "CINEMA", "CIRCLE", "CIRCUIT", "CIRCUS", "CISTERN", "CITATION", "CITIZEN", "CITRON",
"CITY", "CIVIC", "CIVIL", "CIVILIAN", "CLAIM", "CLAM", "CLAMP", "CLAN", "CLAP", "CLARITY",
"CLASH", "CLASP", "CLASS", "CLASSIC", "CLASSIFY", "CLAUSE", "CLAY", "CLEAN", "CLEAR", "CLERGY",
"CLERK", "CLEVER", "CLICK", "CLIENT", "CLIFF", "CLIMATE", "CLIMB", "CLINIC", "CLIP", "CLOAK",
"CLOCK", "CLOG", "CLONE", "CLOSE", "CLOSET", "CLOTH", "CLOTHES", "CLOTHING", "CLOUD", "CLOVER",
"CLOWN", "CLUB", "CLUE", "CLUMP", "CLUMSY", "CLUSTER", "CLUTCH", "COACH", "COAL", "COAST",
"COASTLINE", "COAT", "COBALT", "COBRA", "COBWEB", "COCAINE", "COCKPIT", "COCOA", "COCONUT", "CODE",
"COFFEE", "COFFIN", "COGNAC", "COIL", "COIN", "COINCIDE", "COLD", "COLLAPSE", "COLLAR", "COLLEAGUE",
"COLLECT", "COLLEGE", "COLLIDE", "COLLIER", "COLOGNE", "COLON", "COLONEL", "COLONY", "COLOR", "COLOSSAL",
"COLT", "COLUMN", "COMB", "COMBAT", "COMBINE", "COMEDY", "COMET", "COMFORT", "COMIC", "COMMA",
"COMMAND", "COMMENCE", "COMMEND", "COMMENT", "COMMERCE", "COMMIT", "COMMITTEE", "COMMODITY", "COMMON", "COMMUNICATE",
"COMMUNITY", "COMMUTE", "COMPACT", "COMPANY", "COMPARE", "COMPASS", "COMPEL", "COMPETE", "COMPETENT", "COMPILE",
"COMPLAIN", "COMPLETE", "COMPLEX", "COMPLY", "COMPONENT", "COMPOSE", "COMPOSITE", "COMPOUND", "COMPRESS", "COMPRISE",
"COMPUTE", "COMPUTER", "COMRADE", "CONCEAL", "CONCEDE", "CONCEIT", "CONCEPT", "CONCERN", "CONCERT", "CONCLUDE"
